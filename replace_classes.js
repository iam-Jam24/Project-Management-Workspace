...
function processFile(filePath) {
    ...
    content = content.replace(/bg-white\s+dark:glass\b/g, 'bg-theme-card border border-theme-border');
    ...
    content = content.replace(/bg-white\s+dark:bg-zinc-950/g, 'bg-theme-card');
    content = content.replace(/bg-white\s+dark:glass-dialog/g, 'bg-theme-card border border-theme-border');
    content = content.replace(/bg-white\s+dark:bg-zinc-900/g, 'bg-theme-card border border-theme-border');
    content = content.replace(/bg-white\s+dark:glass-navbar/g, 'bg-theme-surface');
    content = content.replace(/bg-white\s+dark:glass-sidebar/g, 'bg-theme-surface');
